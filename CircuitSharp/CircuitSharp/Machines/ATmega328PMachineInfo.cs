...
namespace CircuitSharp.Machines
{
    public class ATmega328PMachineInfo : MachineInfo
    {
        ...
        public ATmega328PMachineInfo(ATmega328P chip)
        {
            ...
            AddInternalFunction("double map (double x, double inMin, double inMax, double outMin, double outMax)", interpreter =>
            {
                var x = interpreter.ReadArg(0).Float64Value;
            ...
            AddInternalFunction("int SerialClass::print (bool value)", interpreter =>
            {
                interpreter.Push(aTmega328P.SerialPrint(interpreter.ReadArg(0).Int32Value, -1));
            });
            ...
            AddInternalFunction("int SerialClass::println (bool value)", interpreter =>
            {
                interpreter.Push(aTmega328P.SerialPrintln(interpreter.ReadArg(0).Int32Value, -1));
            });
            ...
            AddInternalFunction("int SerialClass::print (double value)", interpreter =>
            {
                interpreter.Push(aTmega328P.SerialPrint(interpreter.ReadArg(0).Float64Value, -1));
            });
            ...
            AddInternalFunction("int SerialClass::println (double value)", interpreter =>
            {
