...
namespace Assets.Scripts.NodeEditor.Scripts
{
    public class PinModeNode : Node
    {
        ...
        [SerializeField]
        private TMP_Dropdown modeField;
        ...
        public override void Setup()
        {
            ...
            modeField.AddOptions(new List<TMP_Dropdown.OptionData>
            {
                new TMP_Dropdown.OptionData(Mode.INPUT.ToString()),
                new TMP_Dropdown.OptionData(Mode.OUTPUT.ToString())
            });

            modeField.onValueChanged.AddListener(selected =>
            {
                OnConnectedValueUpdated();
            });
        ...
        {
            serializer.Add("Port", portField.value.ToString());
            serializer.Add("Mode", modeField.value.ToString());
        }

        public override void OnDeserialize(Serializer serializer)
        {
            var port = int.Parse(serializer.Get("Port"));
            var mode = int.Parse(serializer.Get("Mode"));
